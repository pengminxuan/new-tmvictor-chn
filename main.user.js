...
var CNZ_MAP = {
    ...
    "Returns amount of enabled buildings as number": "以数值形式返回建筑启用的数量",
    "Building Disabled": "建筑停用数量",
    "Returns amount of disabled buildings as number": "以数值形式返回建筑停用的数量",
    ...
    "Trait Level": "特质等级",
    "Returns trait level as number, for major and genus traits return value is either 1 or 0, minor traits can be increased above that": "以数值形式返回特质的等级，对于主修特质和种群特质来说数值为1或者0，对于次要特质来说为特质的等级。",
    "Reset Type": "重置类型",
