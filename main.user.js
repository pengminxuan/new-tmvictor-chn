...
var CNZ_MAP = {
    ...
    "Bioseed: Ignore World Collider": "播种重置：不建造世界超级对撞机",
    "Whitehole: Ignore Jump Ship": "黑洞重置：不建造跃迁飞船",
    ...
    "Study": "研究先祖",
    "Deify": "神化先祖",
    "Research Alien Gift": "是否进行外星礼物研究",

    "Alien Gift increases piracy, you can disable auto research of it if you want to postpone that": "外星礼物研究会使海盗活动更加严重，如果有需要的话您可以关闭它的自动研究",
    ...
    "Hire a mercenary if remaining money will be greater than this percent": "如果聘请后剩余资金大于此比例，则聘请雇佣兵",
