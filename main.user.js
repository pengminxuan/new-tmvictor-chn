...
var CNZ_MAP = {
    ...
    // 侧边栏高级设置
    "Toggle (masterScriptToggle)": "开关(启用脚本)",
    "Toggle (showSettings)": "开关(显示设置)",
    "Toggle (autoEvolution)": "开关(自动进化)",
    "Toggle (autoFight)": "开关(自动战斗)",
    "Toggle (autoHell)": "开关(自动地狱维度)",
    "Toggle (autoMech)": "开关(自动机甲)",
    "Toggle (autoFleet)": "开关(自动仙女座舰队)",
    "Toggle (autoTax)": "开关(自动税率)",
    "Toggle (autoCraft)": "开关(自动锻造)",
    "Toggle (autoBuild)": "开关(自动建筑)",
    "Toggle (autoPower)": "开关(自动供能)",
    "Toggle (autoStorage)": "开关(自动存储)",
    "Toggle (autoMarket)": "开关(自动市场)",
    "Toggle (autoGalaxyMarket)": "开关(自动星际贸易)",
    "Toggle (autoResearch)": "开关(自动研究)",
    "Toggle (autoARPA)": "开关(自动ARPA)",
    "Toggle (autoJobs)": "开关(自动工作)",
    "Toggle (autoCraftsmen)": "开关(自动工匠)",
    "Toggle (autoPylon)": "开关(自动水晶塔)",
    "Toggle (autoQuarry)": "开关(自动温石棉控制)",
    "Toggle (autoSmelter)": "开关(自动冶炼)",
    "Toggle (autoFactory)": "开关(自动工厂)",
    "Toggle (autoMiningDroid)": "开关(自动采矿机器人)",
    "Toggle (autoGraphenePlant)": "开关(自动石墨烯厂)",
    "Toggle (autoAssembleGene)": "开关(自动组装基因)",
    "Toggle (autoMinorTrait)": "开关(自动次要基因)",
    "Variable 1": "变量1",
    "Check": "运算",
    "Variable 2": "变量2",
    "Result": "结果",
    ...
    "Have Trait": "拥有特质",
    "Returns true when current race have selected trait": "如果当前种族拥有所选择的特质，则返回真值",
    "Race Current": "当前种族",
    "Returns true when playing selected race": "如果当前种族为所选择的种族，则返回真值",
    "Race Fanaticism": "狂热信仰种族",
    "Returns true when selected race can be inherited with fanaticism": "如果当前种族是狂热信仰继承特质的种族，则返回真值",
    "Race Deify": "神化先祖种族",
    "Returns true when selected race can be inherited with deify": "如果当前种族是神化先祖继承特质的种族，则返回真值",
    "Universe": "宇宙",
    ...
    "Universe is not chosen yet after Big Bang": "黑洞重置后还未选择宇宙",
    ...
    "With this option enabled Max Build will prevent powering extra building. Can be useful to disable buildigns with overrided settings.": "开启此项后，脚本只会对建造上限数量的建筑进行供能，超出部分不进行供能。可以用来限制以其他方式建造的建筑供能上限。",
